...
return [
    ...
    'title' => 'Ban Chim Bồ Câu — API Documentation',

    // A short description of your API. Will be included in the docs webpage, Postman collection and OpenAPI spec.
    'description' => 'Backend API cho hệ thống bán gia cầm & thú nuôi. Hỗ trợ quản lý sản phẩm, tồn kho, đơn hàng.',

    // Text to place in the "Introduction" section, right after the `description`. Markdown and HTML are supported.
    'intro_text' => <<<'INTRO'
            API documentation cho Ban Chim Bồ Câu — hệ thống bán gia cầm của mẹ.
            ...
            <aside>Các code example bên phải có thể chuyển ngôn ngữ bằng tab ở góc trên.</aside>
        INTRO,
    ...
    'auth' => [
        ...
        'extra_info' => 'Gửi `POST /api/v1/admin/login` với `email` và `password` để nhận token. Thêm header `Authorization: Bearer {token}` cho các admin endpoint. Public endpoint không cần token.',
    ],
